                ...
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        ...
                        <div class="detail-1 d-flex justify-content-start">
                            <div class="category">
                                {{ $company_single->rCompanyIndustry?->name ?? 'N/A' }}
                            </div>
                            <div class="location">
                                {{ $company_single->rCompanyLocation?->name ?? 'N/A' }}
                            </div>
                            <div class="email">
                                    ...
                                    <div class="item d-flex justify-content-start">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="bookmark">
                                                ...
                                                @php
                                                $count =
                                                \App\Models\CandidateBookmark::where('candidate_id',Auth::guard('candidate')->user()->id)->where('job_id',$item->id)->count();
                                                if($count>0) {
                    ...
                    <div class="summary">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><b>Industry:</b></td>
                                    <td>{{ $company_single->rCompanyIndustry ? $company_single->rCompanyIndustry->name : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Location:</b></td>
                                    <td>{{ $company_single->rCompanyLocation ? $company_single->rCompanyLocation->name : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Company Size:</b></td>
                                    <td>{{ $company_single->rCompanySize ? $company_single->rCompanySize->name : 'N/A' }}
                                    </td>
                                </tr>
                                @if($company_single->address)
                                <tr>
                                    <td><b>Address:</b></td>
                                ...
                                @endif
                                @if($company_single->country)
                                <tr>
                                    <td><b>Country:</b></td>
                                    <td>{{ $company_single->country }}</td>
                                </tr>
                                @endif
                                @if($company_single->website)
                                <tr>
                                    <td><b>Website:</b></td>
