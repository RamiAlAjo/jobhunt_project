                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="text" class="form-control h_100" cols="30"
                                                        rows="10">{{ $page_home_data->text }}</textarea>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="job_category_status" class="form-control select2">
                                                        <option value="Show" @if($page_home_data->job_category_status ==
                                                            'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->job_category_status ==
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="why_choose_status" class="form-control select2">
                                                        <option value="Show" @if($page_home_data->why_choose_status ==
                                                            'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->why_choose_status ==
                                                            'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-4" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-4">
                                                    <label class="form-label">Heading *</label>
                                                    <input type="text" class="form-control" name="featured_jobs_heading"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="featured_jobs_status" class="form-control select2">
                                                        <option value="Show" @if($page_home_data->featured_jobs_status
                                                            == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->featured_jobs_status
                                                            == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="testimonial_status" class="form-control select2">
                                                        <option value="Show" @if($page_home_data->testimonial_status ==
                                                            'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->testimonial_status ==
                                                            'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="blog_status" class="form-control select2">
                                                        <option value="Show" @if($page_home_data->blog_status == 'Show')
                                                            selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->blog_status == 'Hide')
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="meta_description" class="form-control h_100"
                                                        cols="30"
                                                        rows="10">{{ $page_home_data->meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- SEO Section End -->
